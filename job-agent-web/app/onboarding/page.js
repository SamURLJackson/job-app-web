            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. Project Management, Python, Salesforce, Patient Care, Financial Modeling..."
                />
              </div>
            </div>
          )}
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g. Marketing Manager, Software Engineer, Nurse Practitioner"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="label">Minimum salary ($/yr)</label>
                  <input className="input" type="number" value={form.salary_floor} onChange={e => set('salary_floor', e.target.value)} placeholder="e.g. 60000" />
                </div>
                <div>
